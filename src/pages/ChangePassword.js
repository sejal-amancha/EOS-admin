...
import { userChangePasswordStart } from '../redux/Actions/actions';
import { Button } from 'primereact/button';

const ChangePassword = () => {
    const users = useSelector((state) => state?.users?.changePass);
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(userChangePasswordStart(userChangePass));
    }
