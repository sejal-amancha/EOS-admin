...
import { addnewCategoryStart } from '../../redux/Actions/categoryActions';
...
const AddCategory = () => {
    ...
    const addCategory = async (e) => {
        ...
        if(categoriesName && image && price && description && Service_ref_id && professional_ref_id) {
                ...
                if (formData) {
                    dispatch(addnewCategoryStart(formData)); 
                    setTimeout(() => {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <div className="font-medium text-4xl text-900 mb-3"> {"Add New Category"}</div>
                </div>
            </React.Fragment>
        );
    };
  ...
  return (
    ...
    <div className="col-12 md:col-6">
                ...
                <div className="formgrid grid">
                        ...
                        <div className="field col">
                            <Button label={"Add" } icon="pi pi-check" className="p-button-warning mr-2 mb-2" onClick={addCategory} />
                        </div>
                </div>
            </div>       
    </div>
